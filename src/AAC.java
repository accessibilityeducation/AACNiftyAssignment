...
public class AAC implements ActionListener {
	...
	public void loadImages(int width, int length) {
		...
		add.setActionCommand("add button");
		...
		if (startIndex > 0) {
			...
			backArrow.setActionCommand("back button");
		...
		if (endIndex < images.length) {
			...
			nextArrow.setActionCommand("next button");
